Ext.define('OMV.module.admin.service.ng2os.Settings', {
...
//
// path: 
//     We want to add the panel in our ng2os node. 
//     The node was configured with the path /service and the id ng2os.
//     The path is therefore /service/ng2os.
//
// className: 
...
OMV.WorkspaceManager.registerPanel({
    ...
    text: _('Settings'),
    position: 10,
    className: 'OMV.module.admin.service.ng2os.Settings'
});